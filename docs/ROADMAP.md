...
- [ ] **Combat log — overhaul (všechny části hry)** 🚧 — přehlednější a čitelnější bojový log (krájeno na slice):
  ...
  - [ ] **Slice 3 — struktura** — celkově vyšší struktura a čitelnost: seskupení podle encounteru/kola, oddělovače, hlavičky.
