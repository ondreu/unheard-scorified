...
> 🔜 **Handoff:** hotovo **MR-1 → MR-7**, **celý cluster deWoWčení** (frakce ✅, PHB rasy ✅, lore „The Caldmoor Reaches" ✅) a **MR-11 — Level cap 20 + XP křivka** ✅ (cap 20, překalibrovaná křivka, obsah přeškálován do 1–20, hra plně hratelná). Combat má D&D dice-roll (MR-5) + bestiář/CR/typové poškození (MR-7). Zbývá: **Onboarding/tutoriál** (redesign po D&D char creation) a **MR-10 — Balance pass** (převzetí D&D čísel: damage dice, CR-based AC/HP/dmg, loot rate, Elo + zahuštění late-game contentu 14–20) — záměrně až nakonec.
