...
- [ ] **Combat log — overhaul (všechny části hry)** 🚧 — přehlednější a čitelnější bojový log (krájeno na slice):
  ...
  - [ ] **Slice 2 — tempo/čitelnost** — **pomalejší, čitelné tempo**: ve skupinovém boji (např. 2v2 v dungeonu) log skáče moc rychle a nejde číst → postupné odhalování řádků v čase (`t`) s ovládáním (throttle / krokování / pauza / rychlost).
