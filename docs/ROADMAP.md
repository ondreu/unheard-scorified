...
- [ ] **Level-up overhaul** _(vyčleněno z Knihy kouzel — rozhodnutí PM)_ — současný Level Up dává **volbu jen na 5 levelech** (subclass + ASI/Feat na 4/8/12/16/19); na zbylých ~14 levelech se na obrazovce neděje nic (žádný feedback, co level přinesl). Cíl: každý level = **událost s feedbackem** (HP, nové spell sloty, nově dostupná kouzla do Knihy, class features) + případně víc voleb. Navazuje na Knihu kouzel.
