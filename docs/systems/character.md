...
- **Resource** dle classy: Warrior=Rage, Rogue=Energy, ostatní=Mana.
- `deriveStats()` (placeholder balanc): `health = 50 + stamina*10 + level*5`; mana = `100 + intellect*15`; rage/energy = 100.
