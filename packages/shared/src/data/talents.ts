...
const WARRIOR_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('warrior.arms.mortal_strike', 'Mortal Strike', 'A powerful strike that wounds the target, reducing healing received by 50%.', 14, 1, { combatTags: ['mortal_strike'] }),
    ],
  },
  {
    name: 'Fury',
    nodes: [
      ...
      n('warrior.fury.bloodthirst', 'Bloodthirst', 'Instantly attack for 45% of your Attack Power. Restores health equal to 10% damage dealt.', 14, 1, { combatTags: ['bloodthirst'] }),
    ],
  },
  {
    name: 'Protection',
    nodes: [
      ...
      n('warrior.prot.last_stand', 'Last Stand', 'Temporarily increases max health by 30% for 20 seconds. Usable once per fight.', 14, 1, { healthPerRank: 50, combatTags: ['last_stand'] }),
    ],
  },
];
...
const PALADIN_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('paladin.holy.holy_light_mastery', 'Holy Light Mastery', 'Reduces cast time of Holy Light by 0.5s and increases its heal by 15%.', 14, 1, { combatTags: ['holy_light_mastery'] }),
    ],
  },
  {
    name: 'Protection',
    nodes: [
      ...
      n('paladin.prot.divine_guardian', 'Divine Guardian', 'Reduces damage taken by the party by 10% for 6 seconds.', 14, 1, { combatTags: ['divine_guardian'] }),
    ],
  },
  {
    name: 'Retribution',
    nodes: [
      ...
      n('paladin.ret.repentance', 'Repentance', 'Incapacitates the target for 6 seconds. Damage breaks the effect.', 14, 1, { combatTags: ['repentance'] }),
    ],
  },
];
...
const HUNTER_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('hunter.bm.bestial_wrath', 'Bestial Wrath', 'Pet goes into a frenzy, increasing damage by 50% for 18s. Pet is immune to crowd control.', 14, 1, { combatTags: ['bestial_wrath'] }),
    ],
  },
  {
    name: 'Marksmanship',
    nodes: [
      ...
      n('hunter.mm.silencing_shot', 'Silencing Shot', 'Silences the target for 3 seconds, dealing weapon damage.', 14, 1, { combatTags: ['silencing_shot'] }),
    ],
  },
  {
    name: 'Survival',
    nodes: [
      ...
      n('hunter.surv.wyvern_sting', 'Wyvern Sting', 'Puts the target to sleep for 12 seconds.', 14, 1, { combatTags: ['wyvern_sting'] }),
    ],
  },
];
...
const ROGUE_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('rogue.ass.mutilate', 'Mutilate', 'Instant attack dealing 200% weapon damage. Awards 2 combo points.', 14, 1, { combatTags: ['mutilate'] }),
    ],
  },
  {
    name: 'Combat',
    nodes: [
      ...
      n('rogue.combat.blade_flurry', 'Blade Flurry', 'Increases attack speed by 20% and hits an additional target for 40% damage.', 14, 1, { combatTags: ['blade_flurry'] }),
    ],
  },
  {
    name: 'Subtlety',
    nodes: [
      ...
      n('rogue.sub.shadowstep', 'Shadowstep', 'Teleport behind the target and increase damage of next ability by 20%.', 14, 1, { combatTags: ['shadowstep'] }),
    ],
  },
];
...
const PRIEST_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('priest.disc.pain_suppression', 'Pain Suppression', 'Instantly reduces threat, then reduces damage taken by 40% for 8s.', 14, 1, { combatTags: ['pain_suppression'] }),
    ],
  },
  {
    name: 'Holy',
    nodes: [
      ...
      n('priest.holy.lightwell', 'Lightwell', 'Creates a Lightwell that party members can click to heal themselves.', 14, 1, { combatTags: ['lightwell'] }),
    ],
  },
  {
    name: 'Shadow',
    nodes: [
      ...
      n('priest.shadow.shadow_form', 'Shadowform', 'Assume a Shadowform, reducing physical damage taken by 15% and increasing Shadow damage by 15%.', 14, 1, { combatTags: ['shadowform'] }),
    ],
  },
];
...
const SHAMAN_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('shaman.ele.thunderstorm', 'Thunderstorm', 'Calls down a bolt of lightning, damaging and knocking back nearby enemies.', 14, 1, { combatTags: ['thunderstorm'] }),
    ],
  },
  {
    name: 'Enhancement',
    nodes: [
      ...
      n('shaman.enh.stormstrike', 'Stormstrike', 'Instant melee attack dealing weapon damage twice. Target takes 20% more Nature damage for 12s.', 14, 1, { combatTags: ['stormstrike'] }),
    ],
  },
  {
    name: 'Restoration',
    nodes: [
      ...
      n('shaman.resto.chain_heal', 'Improved Chain Heal', 'Increases Chain Heal effectiveness by 5% per rank.', 14, 5, { combatTags: ['improved_chain_heal'] }),
    ],
  },
];
...
const MAGE_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('mage.arcane.arcane_power', 'Arcane Power', 'Increases damage by 30% but costs 30% more mana for 15s.', 14, 1, { combatTags: ['arcane_power'] }),
    ],
  },
  {
    name: 'Fire',
    nodes: [
      ...
      n('mage.fire.pyroblast', 'Pyroblast Mastery', 'Reduces cast time of Pyroblast by 0.5s and increases its damage by 15%.', 14, 1, { combatTags: ['pyroblast_mastery'] }),
    ],
  },
  {
    name: 'Frost',
    nodes: [
      ...
      n('mage.frost.cold_snap', 'Cold Snap', 'Resets cooldown of all Frost spells.', 14, 1, { combatTags: ['cold_snap'] }),
    ],
  },
];
...
const WARLOCK_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('warlock.aff.contagion', 'Contagion', 'Reduces chance your DoTs are dispelled by 6% per rank and increases DoT damage by 1%.', 14, 5, { combatTags: ['contagion'] }),
    ],
  },
  {
    name: 'Demonology',
    nodes: [
      ...
      n('warlock.demo.demonic_empowerment', 'Demonic Empowerment', 'Empowers your current demon with a unique ability.', 14, 1, { combatTags: ['demonic_empowerment'] }),
    ],
  },
  {
    name: 'Destruction',
    nodes: [
      ...
      n('warlock.dest.chaos_bolt', 'Chaos Bolt', 'Sends a bolt of chaos at the enemy. Cannot be absorbed or resisted.', 14, 1, { combatTags: ['chaos_bolt'] }),
    ],
  },
];
...
const DRUID_TALENTS: ClassTalents = [
  {
    ...
    nodes: [
      ...
      n('druid.bal.typhoon', 'Typhoon', 'Summons a violent wind storm, damaging and knocking back nearby enemies.', 14, 1, { combatTags: ['typhoon'] }),
    ],
  },
  {
    name: 'Feral',
    nodes: [
      ...
      n('druid.feral.berserk', 'Berserk', 'Reduces energy cost of all attacks by 50% and makes Mangle hit 3 targets for 15s.', 14, 1, { combatTags: ['berserk'] }),
    ],
  },
  {
    name: 'Restoration',
    nodes: [
      ...
      n('druid.resto.tree_of_life', 'Tree of Life', 'Transform into Tree of Life, increasing healing by 15% and enabling Lifebloom.', 14, 1, { combatTags: ['tree_of_life'] }),
    ],
  },
];
