<script lang="ts">
  ...
  // jen na povolený typ aktuálně zvoleného nepřítele → jinak zašednout.
  function invalidForTarget(a: NonNullable<DungeonPartyRunView['you']>['abilities'][number]): boolean {
